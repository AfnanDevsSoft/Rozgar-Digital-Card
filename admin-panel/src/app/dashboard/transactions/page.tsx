    ...
    return (
        <div className="animate-fadeIn">
            <div style={{ marginBottom: '24px' }}>
                ...
                <p style={{ color: '#6b7280', marginTop: '4px' }}>View all billing transactions with discount details</p>
            </div>
                            ...
                            {loading ? (
                                ...
                                transactions.map((tx) => (
                                    <tr key={tx.id}>
                                        ...
                                        <td>
                                            <p style={{ fontWeight: 500 }}>{tx.user.name}</p>
                                        </td>
                                        <td>{tx.lab.name}</td>
                                        <td>{tx.test_name}</td>
                                        ...
                                        <td>
                                            <span className="badge badge-success">
                                                {tx.discount_percentage}% (Rs. {Number(tx.discount_amount).toLocaleString()})
                                            </span>
                                        </td>
